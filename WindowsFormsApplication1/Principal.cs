...
using GeneradorEtiquetasPTIyVentana.WindowsFormsApplication1;
...
namespace WindowsFormsApplication1
{
	...
	public partial class Principal : Form
	{
		...
		private void ConfigurarIndicadorConexion()
		{
			...
			if (Program.WebSocket != null)
			{
				Program.WebSocket.ConnectionStatusChanged += WebSocket_ConnectionStatusChanged;
				Program.WebSocket.MessageReceived += WebSocket_MessageReceived;
				Program.WebSocket.ErrorOccurred += WebSocket_ErrorOccurred;
			}
		...
		private void ActualizarEstadoConexion()
		{
			...
			bool conectado = Program.WebSocket != null && Program.WebSocket.IsConnected;
